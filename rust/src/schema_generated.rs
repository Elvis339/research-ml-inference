...
impl<'a> AntiFraudInput<'a> {
  ...
  pub fn inputs(&self) -> Option<flatbuffers::Vector<'a, f32>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f32>>>(AntiFraudInput::VT_INPUTS, None)}
  }
}
...
impl flatbuffers::Verifiable for AntiFraudInput<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, f32>>>("inputs", Self::VT_INPUTS, false)?
     .finish();
    Ok(())
  }
}
